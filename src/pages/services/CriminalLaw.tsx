...
const CriminalLaw: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0b1a33] text-gray-200" dir={isRTL ? 'rtl' : 'ltr'}>
      <AdvancedSEO
        title={language === 'ar' ? "محامي قانون جنائي في مصر | المحامي كريم الديب" : "Criminal Defense Lawyer in Egypt | Lawyer Karim El-Dib"}
        description={language === 'ar' ? "محامي قانون جنائي - المحامي كريم الديب خبير في الدفاع الجنائي والقضايا الجنائية للمصريين والأجانب في مصر." : "Criminal defense lawyer in Egypt. Expert representation in criminal cases for Egyptians and foreigners."}
        canonicalUrl="https://www.ke-lawyer.com/criminal-law"
      />
      {/* Hero Section */}
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center text-center text-white overflow-hidden bg-[#0b1a33]">
        <img
          src="/images/services/criminal-law.webp"
          alt={isRTL ? "القانون الجنائي - مكتب كريم الديب للمحاماة" : "Criminal Law - Karim El-Dib Law Firm"}
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto mb-6 font-medium text-[#d4a15c]">
            {getTextByLanguage({
              ...
              fr: 'Avocat Karim El-Dib - Expert en défense pénale. Nous fournissons une défense solide et professionnelle pour les Égyptiens et les étrangers.',
              it: 'Avvocato Karim El-Dib - Esperto in difesa penale. Forniamo una difesa forte e professionale per egiziani e stranieri.'
            })}
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'تمثيل كامل أمام النيابات ومحاكم الجنايات والجنح بمحافظة الإسكندرية، والحضور المباشر مع الموكلين في التحقيقات.',
                    en: 'Full representation before prosecution, felony, and misdemeanor courts in Alexandria, attending investigations with clients.',
                    fr: 'Représentation complète devant les tribunaux pénaux à Alexandrie et assistance directe lors des enquêtes.',
                    it: 'Rappresentanza completa davanti ai tribunali penali ad Alessandria e assistenza diretta durante le indagini.'
                  })}
                </p>
              </div>
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'دفاع جنائي عاجل للأجانب والسياح المقيمين والزائرين بشرم الشيخ وجنوب سيناء في جميع المحاضر والتحقيقات العاجلة.',
                    en: 'Urgent criminal defense for foreigners and tourists visiting Sharm El Sheikh and South Sinai in all police reports and investigations.',
                    fr: 'Défense pénale urgente pour les étrangers et touristes à Charm el-Cheikh et dans le Sinaï Sud.',
                    it: 'Difesa penale urgente per stranieri e turisti a Sharm El Sheikh e nel Sinai del Sud.'
                  })}
                </p>
              </div>
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'تمثيل قانوني أمام محكمة النقض بالقاهرة، ومتابعة قضايا تسليم المجرمين والجرائم الدولية العابرة للحدود في القاهرة الكبرى.',
                    en: 'Legal representation before the Court of Cassation in Cairo, handling extradition and cross-border international crimes.',
                    fr: 'Représentation devant la Cour de cassation au Caire, affaires d\'extradition et de criminalité transfrontalière.',
                    it: 'Rappresentanza dinanzi alla Corte di Cassazione al Cairo, casi di estradizione e criminalità transfrontaliera.'
                  })}
                </p>
              </div>
