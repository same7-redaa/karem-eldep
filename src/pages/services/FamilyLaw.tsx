  ...
  return (
    <div className="min-h-screen bg-[#0b1a33] text-gray-200" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center text-center text-white overflow-hidden bg-[#0b1a33]">
        <img
          src="/images/services/family-law.webp"
          alt={isRTL ? "قانون الأسرة - مكتب كريم الديب للمحاماة" : "Family Law - Karim El-Dib Law Firm"}
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto mb-6 font-medium text-[#d4a15c]">
            {getTextByLanguage({
              ...
              fr: 'Avocat Karim El-Dib - Expert en droit de la famille. Nous traitons les affaires familiales avec sensibilité et professionnalisme.',
              it: 'Avvocato Karim El-Dib - Esperto in diritto di famiglia. Gestiamo questioni familiari con sensibilità e professionalità.'
            })}
          </p>
        </div>
      </section>
        ...
        <div className="mb-16 bg-[#1a2d4d]/50 rounded-2xl p-8 border border-[#c8a876]/20 text-white">
          <h2 className="text-3xl font-bold text-center text-[#c8a876] mb-8">
            {getTextByLanguage({
              ...
              it: 'Copertura del Servizio e Aree Operative in Eto'
            })}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'توثيق عقود زواج الأجانب بوزارة العدل بالإسكندرية ومتابعة قضايا الأحوال الشخصية والميراث لعملائنا في مكتب الإسكندرية.',
                    en: 'Documenting foreigners marriage contracts at Ministry of Justice in Alexandria and handling personal status and inheritance disputes.',
                    fr: 'Enregistrement des mariages d\'étrangers au ministère de la Justice à Alexandrie et gestion des litiges familiaux.',
                    it: 'Registrazione di matrimoni di stranieri presso il Ministero della Giustizia ad Alessandria e gestione di controversie familiari.'
                  })}
                </p>
              </div>
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'إنهاء وتوثيق عقود زواج الأجانب والمصريين والنزاعات الأسرية للأجانب المقيمين بشرم الشيخ ومحافظة جنوب سيناء.',
                    en: 'Completing and documenting marriage contracts and resolving family status disputes for foreigners residing in Sharm El Sheikh.',
                    fr: 'Documentation des mariages et résolution des litiges familiaux pour les étrangers résidant à Charm el-Cheikh.',
                    it: 'Documentazione di matrimoni e risoluzione di controversie familiari per stranieri residenti a Sharm El Sheikh.'
                  })}
                </p>
              </div>
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'توثيق عقود زواج الأجانب بمقر وزارة العدل بالقاهرة ومراجعة المستندات وترجمتها أمام السفارات والقنصليات بمحافظة القاهرة.',
                    en: 'Documenting foreigners marriage contracts at Ministry of Justice headquarters in Cairo, and translating papers for embassies.',
                    fr: 'Enregistrement des mariages au siège du ministère de la Justice au Caire, et traduction officielle pour les ambassades.',
                    it: 'Registrazione di matrimoni presso il Ministero della Giustizia al Cairo, e traduzione ufficiale per le ambasciate.'
                  })}
                </p>
              </div>
