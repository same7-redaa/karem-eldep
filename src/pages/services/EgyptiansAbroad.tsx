  ...
  return (
    <div className="min-h-screen bg-[#0b1a33] text-gray-200" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center text-center text-white overflow-hidden bg-[#0b1a33]">
        <img
          src="/images/services/egyptians-abroad.webp"
          alt={isRTL ? "خدمات المصريين المغتربين - مكتب كريم الديب للمحاماة" : "Egyptians Abroad - Karim El-Dib Law Firm"}
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto mb-6 font-medium text-[#d4a15c]">
            {getTextByLanguage({
              ...
              fr: 'Avocat Karim El-Dib - Avocat international. Services juridiques pour les expatriés égyptiens. Votre pont juridique avec l\'Égypte.',
              it: 'Avvocato Karim El-Dib - Avvocato internazionale. Servizi legali per espatriati egiziani. Il tuo ponte legale con l\'Egitto.'
            })}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'تمثيل كامل للمصريين المغتربين في قضايا الميراث، وإدارة العقارات، والتوكيلات وتملك العقارات بمكتبنا بالإسكندرية.',
                    en: 'Full representation for Egyptian expats in inheritance cases, property management, and real estate purchases at Alexandria office.',
                    fr: 'Représentation complète pour les expatriés égyptiens dans les affaires d\'héritage et de gestion immobilière à Alexandrie.',
                    it: 'Rappresentanza per espatriati egiziani in casi di eredità e gestione immobiliare ad Alessandria.'
                  })}
                </p>
              </div>
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'إدارة وتسييل الاستثمارات السياحية، ومتابعة قضايا الأحوال الشخصية وعقود تملك الفنادق والقرى للمغتربين بشرم الشيخ.',
                    en: 'Managing tourism investments, handling personal status issues, and hotel/resort ownership contracts in Sharm El Sheikh.',
                    fr: 'Gestion des investissements touristiques, affaires familiales et contrats de propriété à Charm el-Cheikh.',
                    it: 'Gestione degli investimenti turistici, questioni familiari e contratti di proprietà a Sharm El Sheikh.'
                  })}
                </p>
              </div>
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'تمثيل قانوني أمام مصلحة الضرائب العقارية، وزارة الخارجية، السجل التجاري، والتوثيق بالشهر العقاري في القاهرة.',
                    en: 'Legal representation before Real Estate Tax Authority, Foreign Ministry, Commercial Registry, and Notary Public in Cairo.',
                    fr: 'Représentation devant le fisc immobilier, le ministère des Affaires étrangères et le Notaire Public au Caire.',
                    it: 'Rappresentanza dinanzi all\'autorità fiscale immobiliare, ministero degli Esteri e Notaio al Cairo.'
                  })}
                </p>
              </div>
