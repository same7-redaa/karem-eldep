    ...
    <div className="min-h-screen bg-[#0b1a33] text-gray-200" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center text-center text-white overflow-hidden bg-[#0b1a33]">
        <img
          ...
          alt={isRTL ? "القانون المدني - مكتب كريم الديب للمحاماة" : "Civil Law - Karim El-Dib Law Firm"}
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto mb-6 font-medium text-[#d4a15c]">
            {getTextByLanguage({
              ...
              fr: 'Avocat Karim El-Dib - Expert en droit civil égyptien. Services juridiques complets en indemnisation, contrats, litiges immobiliers et succession.',
              it: 'Avvocato Karim El-Dib - Esperto in diritto civile egiziano. Servizi legali completi in risarcimento, contratti, controversie immobiliari ed eredità.'
            })}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'مباشرة دعاوى الحقوق المدنية والتعويضات، وصياغة عقود البيع والشراء والرهن العقاري وتوثيق الملكية بالإسكندرية.',
                    en: 'Handling civil rights and compensation lawsuits, drafting purchase and sale agreements, and property registration in Alexandria.',
                    fr: 'Gestion des litiges civils et indemnités, rédaction de contrats de vente et d\'enregistrement immobilier à Alexandrie.',
                    it: 'Gestione di controversie civili e risarcimenti, redazione di contratti di vendita e registrazione immobiliare ad Alessandria.'
                  })}
                </p>
              </div>
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'صياغة وتسجيل عقود الفنادق وتملك العقارات والوحدات السياحية للأجانب وحل نزاعات عقود الإيجار والاستثمار بشرم الشيخ.',
                    en: 'Drafting and registering hotel agreements, real estate purchases for foreigners, and tenancy disputes in Sharm El Sheikh.',
                    fr: 'Rédaction et enregistrement de contrats hôteliers et immobiliers pour les étrangers à Charm el-Cheikh.',
                    it: 'Redazione e registrazione di contratti alberghieri e immobiliari per stranieri a Sharm El Sheikh.'
                  })}
                </p>
              </div>
            ...
            <div className="bg-[#0b1a33]/60 rounded-xl p-6 border border-[#c8a876]/10 flex flex-col justify-between items-center text-center">
              <div>
                ...
                <p className="text-sm text-gray-300 mb-4">
                  {getTextByLanguage({
                    ar: 'رفع دعاوى صحة التوقيع وصحة ونفاذ العقود أمام محاكم القاهرة الكبرى والتمثيل في نزاعات الملكية الفكرية والتعويضات.',
                    en: 'Filing signature validation and contract validation lawsuits in Cairo courts, representing intellectual property disputes.',
                    fr: 'Dépôt de plaintes de validation de signature et de contrat devant les tribunaux du Caire, et litiges de propriété intellectuelle.',
                    it: 'Cause di convalida della firma e del contratto presso i tribunali del Cairo, e controversie di proprietà intellettuale.'
                  })}
                </p>
              </div>
