          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-10">
              ...
              <div className="relative z-10 flex flex-col items-center text-center h-full justify-between">
                <div className="flex flex-col items-center w-full">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-white mb-3">
                    {getTextByLanguage({
                      ar: 'المكتب الرئيسي - الإسكندرية',
                      en: 'Main Office - Alexandria',
                      fr: 'Bureau Principal - Alexandrie',
                      it: 'Ufficio Principale - Alessandria'
                    })}
                  </h3>

                  <a
                    href="https://www.google.com/maps/place/Karim+El+Deeb+Lawyer/@31.1997224,29.8994763,17z"
                    target="_blank"
                ...
                <Link
                  to="/alexandria"
                  className="mt-6 inline-flex items-center gap-1.5 px-4 py-1.5 bg-[#d4a15c]/10 hover:bg-[#d4a15c]/25 border border-[#d4a15c]/30 hover:border-[#d4a15c]/50 rounded-full text-xs font-semibold text-[#d4a15c] hover:text-white transition-all duration-300"
                >
                  {t('services.learnMore')} &larr;
                </Link>
              </div>
            </div>
              ...
              <div className="relative z-10 flex flex-col items-center text-center h-full justify-between">
                <div className="flex flex-col items-center w-full">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-white mb-3">
                    {getTextByLanguage({
                      ar: 'فرع شرم الشيخ',
                      en: 'Sharm El Sheikh Branch',
                      fr: 'Succursale - Sharm El Sheikh',
                      it: 'Filiale - Sharm El Sheikh'
                    })}
                  </h3>

                  <a
                    href="https://www.google.com/maps/place/Karim+El+Deeb+Law+firm/@27.8524719,34.3032662,17z"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 text-gray-300 hover:text-[#d4a15c] transition-colors duration-300 group/link"
                  >
            ...
            <div className="group bg-gradient-to-br from-[#1a2f5a]/40 to-[#0f1d38]/40 backdrop-blur-xl border border-[#d4a15c]/20 rounded-xl p-6 md:p-8 hover:border-[#d4a15c]/50 hover:shadow-2xl hover:shadow-[#d4a15c]/10 transition-all duration-300">
              ...
              <div className="relative z-10 flex flex-col items-center text-center h-full justify-between">
                <div className="flex flex-col items-center w-full">
                  <div className="mb-4 inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#d4a15c]/20 group-hover:bg-[#d4a15c]/30 transition-colors duration-300">
                    <i className="fas fa-landmark text-[#d4a15c] text-2xl"></i>
                  </div>

                  <h3 className="text-lg md:text-xl font-bold text-white mb-3">
                    {getTextByLanguage({
                      ar: 'مكتب التمثيل القانوني - القاهرة',
                      en: 'Legal Representation Office - Cairo',
                      fr: 'Bureau de Représentation - Le Caire',
                      it: 'Ufficio di Rappresentanza - Il Cairo'
                    })}
                  </h3>

                  <div className="inline-flex items-center justify-center gap-2 text-gray-300 transition-colors duration-300">
                    <i className="fas fa-map-marker-alt text-[#d4a15c] flex-shrink-0"></i>
                    <span className="text-sm md:text-base">
                      {getTextByLanguage({
                        ar: 'تغطية منطقة القاهرة الكبرى والتأسيس',
                        en: 'Greater Cairo Area Coverage & Formation',
                        fr: 'Couverture du Grand Caire & Création',
                        it: 'Copertura del Grande Cairo e Costituzione'
                      })}
                    </span>
                  </div>
                </div>
