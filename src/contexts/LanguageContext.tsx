...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'services.maritime.desc': 'تسوية نزاعات الشحن البحري وتخليص البضائع وحل المشاكل القانونية في الموانئ الرئيسية',
  ...
  en: {
    ...
    'services.maritime.desc': 'Resolving maritime transport disputes, customs clearance issues, and legal matters at major ports and the Suez Canal',
  ...
  fr: {
    ...
    'services.maritime.desc': 'Résolution de litiges de transport maritime, dédouanement et affaires juridiques aux ports majeurs et au canal de Suez',
  ...
  it: {
    ...
    'services.maritime.desc': 'Risoluzione di controversie sul trasporto marittimo, sdoganamento e questioni legali nei porti principali e nel Canale di Suez',
