...
const FAQ: React.FC = () => {
    ...
    const faqs: FAQItem[] = [
        ...
        },
        {
            ...
            answerAr: 'تختلف التكلفة حسب نوع الشركة ورأس المال. بشكل عام، تبدأ من 10,000 جنيه للشركات الصغيرة. نحن نقدم استشارة مجانية لتحديد التكلفة الدقيقة حسب احتياجاتك.',
            answerEn: 'Costs vary depending on company type and capital. Generally, it starts from EGP 10,000 for small companies. We offer a free consultation to determine the exact cost based on your needs.',
            answerFr: 'Les coûts varient selon le type d\'entreprise et le capital. En général, cela commence à partir de 10 000 EGP pour les petites entreprises. Nous offrons une consultation gratuite pour déterminer le coût exact selon vos besoins.',
            answerIt: 'I costi variano a seconda del tipo di società e del capitale. In generale, parte da 10.000 EGP per le piccole società. Offriamo una consulenza gratuita per determinare il costo esatto in base alle tue esigenze.',
            category: 'business'
        },
        // العقارات
        {
